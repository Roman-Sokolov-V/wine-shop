...
export const CatalogPage = () => {
  ...
  useEffect(() => {
    const preSeachParam = new URLSearchParams(prevSearchParams);
    console.log(preSeachParam.toString());
    console.log(searchParams.toString());
    console.log(
      'perpage',
      searchParams.get(QueryNames.PER_PAGE) !==
        preSeachParam.get(QueryNames.PER_PAGE),
    );
    console.log(
      'SORT',
      searchParams.get(QueryNames.SORTED) !==
        preSeachParam.get(QueryNames.SORTED),
    );
    if (
      searchParams.get(QueryNames.PER_PAGE) !==
      preSeachParam.get(QueryNames.PER_PAGE)
    ...
    if (
      searchParams.get(QueryNames.QUERY) !== preSeachParam.get(QueryNames.QUERY)
    ) {
  ...
  console.log(filteredPets[0]?.name);
  useEffect(() => {
    console.log('updated filterd');
    setPages(
      genPages(
        filteredPets,
    ...
    <div>
      ...
      <Columns>
        ...
        <Columns.Column>
          ...
          <CatalogList pets={pages[curPage - 1]} />
