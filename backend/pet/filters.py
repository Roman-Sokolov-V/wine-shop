...
class CaseInsensitiveInFilter(BaseInFilter):
...
class PetFilter(django_filters.FilterSet):
    ...
    age__gt = django_filters.NumberFilter(field_name="weight", lookup_expr="gt")
    age__lt = django_filters.NumberFilter(field_name="weight", lookup_expr="lt")
    age__gte = django_filters.NumberFilter(field_name="weight", lookup_expr="gte")
    age__lte = django_filters.NumberFilter(field_name="weight", lookup_expr="lte")
    age__gte = django_filters.NumberFilter(field_name="weight", lookup_expr="gte")
    age__lte = django_filters.NumberFilter(field_name="weight", lookup_expr="lte")
